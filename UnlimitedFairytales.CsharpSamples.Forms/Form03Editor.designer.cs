namespace UnlimitedFairytales.CsharpSamples.Forms
{
	partial class Form03Editor
	{
		...
		private void InitializeComponent()
		{
			...
			this.userGuideToolStripMenuItem.Size = new System.Drawing.Size(157, 22);
			...
			this.label1.Text = "1、メニューバーやツールバーは、menuStripやstatusStripで実現する\r\n\r\n2、メニューの項目は、ToolStripMenuItemで構成される\r" +
				"\n・ShortcutKeysでショートカットキーを設定する\r\n・CheckOnClickをTrueにすると、チェックの切り替えができるようになる";
			// 
			// Form03Editor
			// 
			this.AllowDrop = true;
			...
			this.Name = "Form03Editor";
			this.Text = "Form03Editor";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.Form03Editor_FormClosing);
			this.Load += new System.EventHandler(this.Form03Editor_Load);
			this.DragDrop += new System.Windows.Forms.DragEventHandler(this.Form03Editor_DragDrop);
			this.DragEnter += new System.Windows.Forms.DragEventHandler(this.Form03Editor_DragEnter);
