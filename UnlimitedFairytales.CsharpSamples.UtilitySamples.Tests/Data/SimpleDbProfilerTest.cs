...
using System.IO;
using UnlimitedFairytales.CsharpSamples.UtilitySamples.Data;
using Xunit;

namespace UnlimitedFairytales.CsharpSamples.UtilitySamples.Tests.Data
{
    public class SimpleDbProfilerTest
    {
