...
{
    public class StringToDateTimeExtensionTest
    {
        [Fact]
        public void TestLocalToLocal()
        {
            ...
            Assert.Equal(d3, "2018/08/31 23:59:59.123".LocalToLocal());
            // Assert 4
            Assert.Equal(d4, "20180831T235959+1200".LocalToLocal().Value.AddHours(+12));
            // Assert 5
            Assert.Equal(d4, "2018-08-31T23:59:59+12:00".LocalToLocal().Value.AddHours(+12));
        }
